$(function(){
    ...
    var $grid = $('#data_grid').datagrid({
        url: ksa.buildUrl( "/data/finance/profit", "query"/*(NATURE == 1 ? "query" : "query-foreign")*/, { STATE:2 } ),
        fit : true,
        border:false,
        pageSize: 20,
        fitColumns: false,
        columns:[ GET_PROFIT_TABLE_COLUMN( { 'creator_name':false,'charge_date':false,'departure_port':false,'destination_port':false } ) ],
