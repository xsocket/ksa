        ...
        if( state.options.href && ( !state.isLoaded || !state.options.cache ) ) {
            ...
            $.ajax( {
                ...
                success : function( _1f ) {
                    pbody.html( state.options.extractor.call( target, _1f ) );
                    if( $.parser ) {
                        $.parser.parse( pbody );
                    }
...
( function( $ ) {
    ...
    function createDialog( title, content, buttons ) {
        ...
        if( buttons ) {
            ...
            for( var label in buttons ) {
                $( "<a></a>" ).attr( "href", "javascript:void(0)" ).text( label ).css( "margin-left", 10 ).bind( "click",
    ...
    $.messager = {
        ...
        confirm : function( title, msg, fn ) {
            var content = "<div class=\"messager-icon messager-question\"></div>" + "<div>" + msg + "</div>"
