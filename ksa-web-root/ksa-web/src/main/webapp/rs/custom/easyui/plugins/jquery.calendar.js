...
if($.data(_6, 'calendar').options.monthMode){_14(_6);}
else if(_7.is(":visible")){
_7.hide();
}else{
_14(_6);
}
...
_d(_15);
// monthMode
if( _16.monthMode ) {_16.current = new Date(_16.year, _16.month - 1, 1);_16.onSelect.call(_15, _16.current);}
}
if( !_16.monthMode ){_19.hide();}
};
...
_d(this);
//monthMode
if( !_3a.options.monthMode ) {$(this).find('div.calendar-menu').hide();} 
else{$(this).find('.calendar-title span').click();}
});
};
...
$.fn.calendar.defaults={monthMode:false,width:180,height:180,fit:false,border:true,firstDay:0,weeks:["S","M","T","W","T","F","S"],months:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(_3d){
}};
})(jQuery);
