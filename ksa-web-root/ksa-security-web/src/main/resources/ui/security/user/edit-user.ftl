...
<body>
<form id="dialog_container" method="post" class="easyui-form" action="<@s.url namespace="/dialog/security/user" action="update" />">
<div class="easyui-layout" data-options="fit:true">
	...
	<div class="form-horizontal" data-options="region:'center'" style="padding:10px;">
		...
		<div class="control-group">
			...
			<div class="controls">
		    	<input id="user_id" type="text" name="id" value="${user.id!""}" readonly="readonly"
		...
		<div class="control-group">
			...
			<div class="controls">
		    	<input type="password" name="passwordOld"
		    		class="easyui-validatebox" data-options="validType:'script[\'validateOldPassword()\', \'请输入原登录密码\']'" />
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
		    	<input type="password" name="password"
		    		class="easyui-validatebox" data-options="validType:'script[\'validateNewPassword()\', \'请输入新登录密码\']'" />
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
		    	<input type="password" name="passwordAgain"
		    		class="easyui-validatebox" data-options="validType:'script[\'validatePassword()\', \'两次密码输入不一致\']'" />
			</div>
		</div>
		<#-- end : control-group -->
