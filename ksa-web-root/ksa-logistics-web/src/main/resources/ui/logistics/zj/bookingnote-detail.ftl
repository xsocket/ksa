...
<div class="form-inline">
	...
	<div class="control-group">
		...
		<div class="controls" style="margin-left:65px">
	    	<input type="text" readonly="readonly" value="证件代办" />
		</div>
	</div>
	<div class="control-group">
...
<fieldset class="form-inline">
	...
	<img title="空运进口" alt="空运进口" src="<@s.url value="/rs/images/type/AI.png" />" class="img-polaroid logistics-logo" />
	<div class="control-group">
		<label class="control-label">报关单号：</label>
		<div class="controls">
			<input type="text" name="customsCode" value="${model.customsCode!}" <#if isReturned>readonly="readonly"</#if> />
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">报关日期：</label>
		<div class="controls">
	    	<input type="text" name="customsDate" class="easyui-datebox" <#if model.customsDate??>value="${model.customsDate?date}"</#if> <#if isReturned>readonly="readonly"</#if> />
		</div>
	</div>
	<div class="control-group">
...
<div style="float:left;margin:10px 10px 0 0">	
	<div class="control-group">
		...
		<div class="controls">
			<textarea name="cargoName" rows="3"
	...
	<div class="control-group"><#-- 用 cargoContainer（箱类箱型）暂存计费重量  -->
		<label class="control-label">C.W：</label>
		<div class="controls input-append" style="margin-left:0;">
	    	<input type="text" name="cargoContainer" style="text-align:right;" value="${model.cargoContainer!}" />
		<span class="add-on">kg</span>
		</div>
	</div>
	<br/><#-- 换行 -->
...
<fieldset class="form-inline">
	...
	<div class="control-group">
		<label class="control-label">航班：</label>
		<div class="controls">
	...
	<div class="control-group">
		<label class="control-label">出航日：</label>
		<div class="controls">
