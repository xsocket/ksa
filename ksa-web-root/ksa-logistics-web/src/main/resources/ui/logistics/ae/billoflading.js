$(function(){
    ...
    //initCombobox( "#loading_port, #discharge_port, #destination_port", ksa.buildUrl( "/data/combo", "bd-data-bytype", { typeId : '32-port-air' } ), { valueField : "code", width: 150 } );
