$(function(){
    $("button[data-download], a[data-download]").click(function() {
        ...
        var form = $( "<form action='"+ksa.buildUrl( "/dialog/logistics/arrivalnote", "download-ae")+"' method='POST' style='display:none;top:-100px;left:-100px;height:0;width:0'></form>" ).appendTo( $("body") );
        form.form("submit", {  
            url: ksa.buildUrl( "/dialog/logistics/arrivalnote", "download-ae"),  
            onSubmit: function() {
