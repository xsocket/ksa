...
<div class="form-inline">
	...
	<div class="control-group">
		...
		<div class="controls" style="margin-left:65px">
	    	<input type="text" readonly="readonly" value="空运出口" />
		</div>
	</div>
	<div class="control-group">
...
<fieldset class="form-inline">
	...
	<img title="空运出口" alt="空运出口" src="<@s.url value="/rs/images/type/AE.png" />" class="img-polaroid logistics-logo" />
	<div class="control-group">
...
<div style="float:left;margin:10px 10px 0 0">	
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea name="shippingMark" rows="3" class="input-xxlarge">${model.shippingMark!}</textarea>
		</div>
	</div> <br/>
	<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
	    	<textarea name="cargoNote" rows="3" class="input-xxlarge">${model.cargoNote!}</textarea>
		</div>
	</div>
</div>	<#-- end 货物属性 -->
