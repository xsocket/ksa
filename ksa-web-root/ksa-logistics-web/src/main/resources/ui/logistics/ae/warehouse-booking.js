$(function(){
   ...
   initCombobox( "#departure_port, #destination_port", ksa.buildUrl( "/data/combo", "bd-data-bytype", { typeId : '32-port-air' } ), { valueField:"code", codeField : "name", textField:"code", width: width } );
