$(function(){
    ...
    initCombobox( "#loading_port, #discharge_port", ksa.buildUrl( "/data/combo", "bd-data-bytype", { typeId : '31-port-sea' } ), { valueField : "name", width: width } );
    ...
    $("button[data-download], a[data-download]").click(function() {
        ...
        var form = $( "<form action='"+ksa.buildUrl( "/dialog/logistics/warehousenoting", "download-se")+"' method='POST' style='display:none;top:-100px;left:-100px;height:0;width:0'></form>" ).appendTo( $("body") );
        form.form("submit", {  
            url: ksa.buildUrl( "/dialog/logistics/warehousenoting", "download-se"),  
            onSubmit: function() {
