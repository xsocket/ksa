...
<input type="hidden" name="type" value="SE" />
...
<div class="form-inline">
	...
	<div class="control-group">
		...
		<div class="controls" style="margin-left:65px">
	    	<input type="text" readonly="readonly" value="海运出口" />
		</div>
	</div>
	<div class="control-group">
	...
	<#-- end : control-group -->
	<div class="control-group">
		<label class="control-label">细分类型：</label>
		<div class="controls" style="margin-left:65px">
	    	<input id="subType" type="text" name="subType" value="${model.subType!}" />
		</div>
	</div>
</div>
...
<fieldset class="form-inline">
	...
	<img title="海运出口" alt="海运出口" src="<@s.url value="/rs/images/type/SE.png" />" class="img-polaroid logistics-logo" />
	<div class="control-group">
