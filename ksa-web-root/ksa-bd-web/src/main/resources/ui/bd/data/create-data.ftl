<!DOCTYPE html>
<html lang="zh">
<head><title>新建基本代码</title>
<style type="text/css">
.form-horizontal { padding:10px; }
</style>
</head>
<body>
<form id="dialog_container" method="post" class="easyui-form" action="<@s.url namespace="/dialog/bd/data" action="insert" />">
<div class="easyui-panel form-horizontal" data-options="fit:true">
	...
	<div class="control-group">
		...
		<div class="controls">
	    	<input type="text" name="rank" value="${data.rank?c}" style="text-align:right;"
