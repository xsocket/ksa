...
public class PartnerUpdateAction extends PartnerAction {

    private static final long serialVersionUID = 1198212413777749183L;

    @Override
    public String doExecute() throws Exception {
        PartnerService service = ServiceContextUtils.getService( PartnerService.class );
        partner = service.modifyPartner( partner );
        addActionMessage( String.format( "成功更新合作伙伴信息：'%s'。", partner.getName() ) );
        return SUCCESS;
    }
